...
export default function About() {
  return (
    <section
      id="about"
      className="grid grid-cols-12 my-8 gap-y-8 lg:gap-y-16 text-xl lg:text-2xl relative overflow-hidden lg:overflow-visible"
    >
      ...
      <div className="col-start-1 col-end-12 text-center lg:text-left">
